...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Render videos using TF tracking results.")
    parser.add_argument("--result_dir", type=Path, default=ROOT / "tracks_tf")
    parser.add_argument("--mot_dir", type=Path, default=ROOT / "MOT16" / "train")
    parser.add_argument("--output_dir", type=Path, default=ROOT / "videos_tf")
