...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run tracker using TF detections.")
    parser.add_argument("--sequence", required=True, help="Sequence name, e.g., MOT16-02")
    parser.add_argument("--detections_dir", type=Path, default=ROOT / "resources" / "detections_tf")
    parser.add_argument("--tracks_dir", type=Path, default=ROOT / "tracks_tf")
